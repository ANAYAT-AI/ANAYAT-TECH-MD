const mindReads = [
  ...
  "*ANAYAT-TECH-MD* detected some deep thoughts 👁️✨",
  ...
  "*🧘 Energy level rising... ANAYAT-TECH-MD reading deeper...*",
...
module.exports = {
  name: "mindread",
  description: "🧠 Reads the replied user's mind using ANAYAT-TECH-MD deep AI magic ✨",
  category: "fun",
